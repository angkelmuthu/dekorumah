...
<body>
	...
	<div id="pageWrapper">
							...
							<ul class="list-unstyled topBarContactList align-items-center mb-0 d-none d-md-flex">
								<li>
									<a href="tel:+&#049;&#050;&#051;&#052;&#053;&#054;&#055;&#056;&#057;&#048;">
										...
										<span class="d-none d-lg-inline">(+123) 456 7890</span>
									</a>
								</li>
								<li>
					...
					<div class="row align-items-md-center">
						<div class="col-12 col-md-7">
							...
							<ol class="breadcrumb pageBreadcrumb m-0 p-0 text-capitalize">
								...
								<li class="breadcrumb-item"><a href="shop-details.html">shop</a></li>
								<li class="breadcrumb-item active" aria-current="page">Shop Sidebar</li>
							</ol>
						</div>
						<div class="col-12 col-md-5 d-none d-md-flex align-items-md-center justify-content-md-end">
							<!-- title -->
							<strong class="title d-block text-right fontRoboto fwMedium text-capitalize text-dark">Shop Slide Bar</strong>
						</div>
					</div>
				</div>
			</nav>
				...
				<div class="container">
					...
					<article id="content" class="mb-5">
							...
							<div class="row align-items-md-center">
								<div class="col-9 col-md-5">
									<p>
										...
										<a class="text-capitalize filtersSidebarOpener" data-toggle="collapse" href="#filtersSidebarCollapse" role="button" aria-expanded="false" aria-controls="filtersSidebarCollapse">
											<i class="fas fa-cogs icn"><span class="sr-only">icon</span></i>
											<span class="d-none d-sm-inline">Filter</span>
										</a>
										<strong class="font-weight-normal">Showing 10–18 of 55 results</strong>
									</p>
								</div>
								<div class="col-3 col-md-7 d-md-flex justify-content-md-end">
									<!-- dsSortDropdown -->
									<div class="dropdown dsSortDropdown d-none d-md-block">
										<a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Default Sorting</a>
										<!-- dropdown menu -->
									...
									<!-- viewSorterList -->
									<ul class="list-unstyled viewSorterList d-flex justify-content-end align-items-center mb-0">
										<li><a href="#"><i class="fas fa-bars"><span class="sr-only">icon</span></i></a></li>
										<li class="active"><a href="#"><i class="fas fa-th-large"><span class="sr-only">icon</span></i></a></li>
									</ul>
								</div>
							</div>
						</header>
						<div class="row">
									...
									<div class="aligncenter imageHolder rounded position-relative d-flex">
										<span class="d-flex align-items-center wrap justify-content-center w-100">
											<span class="d-block w-100">
												<img src="http://placehold.it/270x380" alt="image description">
											</span>
										</span>
										<!-- popActionsList -->
										<ul class="list-unstyled popActionsList d-flex justify-content-center mb-0 position-absolute">
											<li>
												<a href="javascript:void(0);" class="rounded-circle d-flex align-items-center justify-content-center">
													<i class="fas fa-recycle d-block"><span class="sr-only">icon</span></i>
												</a>
											</li>
											<li>
												<a href="javascript:void(0);" class="rounded-circle d-flex align-items-center justify-content-center">
													<i class="fas fa-heart d-block"><span class="sr-only">icon</span></i>
												</a>
											</li>
											<li>
												<a href="shoping-cart.html" class="rounded-circle d-flex align-items-center justify-content-center">
													<i class="fas fa-cart-plus d-block"><span class="sr-only">icon</span></i>
												</a>
											</li>
										</ul>
									</div>
									<h3 class="text-capitalize"><a href="shop-details.html">LOG Table Pro</a></h3>
									<h4 class="font-weight-normal">$19.99</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall hasOver text-center" data-featured-tag="Sale">
									<!-- imageHolder -->
									<div class="aligncenter imageHolder rounded position-relative d-flex">
										<span class="d-flex align-items-center wrap justify-content-center w-100">
											<span class="d-block w-100">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">SO/HO Stool</a></h3>
									<h4 class="font-weight-normal">$29.99 <span class="priceCut">$38.90</span></h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver">
									<!-- imageHolder -->
									<div class="aligncenter imageHolder rounded position-relative d-flex">
										<span class="d-flex align-items-center wrap justify-content-center w-100">
											<span class="d-block w-100">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Barn Table</a></h3>
									<h4 class="font-weight-normal">$16.09</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver" data-featured-tag="hot" data-tag-hot>
									<!-- imageHolder -->
									<div class="aligncenter imageHolder rounded position-relative d-flex">
										<span class="d-flex align-items-center wrap justify-content-center w-100">
											<span class="d-block w-100">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Afteroom Lounge Chair</a></h3>
									<h4 class="font-weight-normal">$19.99</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								...
								<article class="popItemColumn hMbSmall text-center hasOver">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Miro Stool</a></h3>
									<h4 class="font-weight-normal">$29.99</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver" data-featured-tag="hot" data-tag-hot>
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Typecast Chair</a></h3>
									<h4 class="font-weight-normal">$16.09 <span class="priceCut">$19.99</span></h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Boro Wall Shelf</a></h3>
									<h4 class="font-weight-normal">29.99</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver" data-featured-tag="sale">
									<!-- imageHolder -->
									<div class="aligncenter imageHolder rounded position-relative d-flex">
										<span class="d-flex align-items-center wrap justify-content-center w-100">
											<span class="d-block w-100">
							...
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								...
								<article class="popItemColumn hMbSmall text-center hasOver">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Wing Stand</a></h3>
									<h4 class="font-weight-normal">$16.09 <span class="priceCut">$38.99</span></h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Icha Desk</a></h3>
									<h4 class="font-weight-normal">$22.09</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Bird Stool</a></h3>
									<h4 class="font-weight-normal">$17.99</h4>
								</article>
							</div>
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<!-- popItemColumn -->
								<article class="popItemColumn hMbSmall text-center hasOver" data-featured-tag="Sale">
									...
									<h3 class="text-capitalize"><a href="shop-details.html">Sled Sideboard</a></h3>
									<h4 class="font-weight-normal">$16.09 <span class="priceCut">$38.99</span></h4>
								</article>
							</div>
						</div>
						...
						<nav aria-label="Page navigation">
							<!-- pagination -->
							<ul class="pagination pagePagination justify-content-center text-center mb-0">
								...
								<li class="page-item"><a class="page-link" href="javascript:void(0);"><i class="fas fa-angle-right"><span class="sr-only">icon</span></i></a></li>
							</ul>
						</nav>
					</article>
				</div>
		...
		<!-- filtersSidebarFWrap -->
		<div class="filtersSidebarFWrap position-absolute bg-white hasShadow collapse d-block" id="filtersSidebarCollapse">
			<!-- fSFWHolder -->
			<div class="fSFWHolder">
				<!-- titleWrap -->
				<div class="titleWrap position-relative">
					<!-- fTitle -->
					<strong class="fTitle h h2 d-block text-uppercase">Filter</strong>
					<!-- btnClose -->
					<a class="btnClose position-absolute d-flex align-items-center justify-content-center" data-toggle="collapse" href="#filtersSidebarCollapse" role="button" aria-expanded="false" aria-controls="filtersSidebarCollapse"><i class="ei_icon_close"><span class="sr-only">icon</span></i></a>
				</div>
				<!-- sidebar -->
				<aside id="sidebar">
					<!-- widget search -->
					<div class="widget widget_search">
						<h3 class="sr-only text-capitalize">Search</h3>
						<!-- search form -->
						<form action="#" class="search-form position-relative" method="get">
							<input type="search" class="form-control d-block w-100" placeholder="Searching&hellip;" name="s">
					...
					<nav class="widget widget_categories">
						...
						<ul class="m-0 p-0 list-unstyled">
							<li class="cat-item cat-item1"><a href="javascript:void(0);" class="position-relative d-block">Cabinets</a></li>
							<li class="cat-item cat-item2"><a href="javascript:void(0);" class="position-relative d-block">Chair Wood</a></li>
							<li class="cat-item cat-item3"><a href="javascript:void(0);" class="position-relative d-block">Table Wood</a></li>
							<li class="cat-item cat-item4"><a href="javascript:void(0);" class="position-relative d-block">Fridge Wall</a></li>
							<li class="cat-item cat-item5"><a href="javascript:void(0);" class="position-relative d-block">Gas Stove</a></li>
							<li class="cat-item cat-item6"><a href="javascript:void(0);" class="position-relative d-block">Dishwasher</a></li>
						</ul>
					</nav>
					<!-- widgetPriceFilter -->
					<div class="widget widgetPriceFilter">
						<h3 class="text-capitalize">Filter By Price</h3>
						<!-- slider range -->
						...
						<div class="getResultsWrap d-flex align-items-center justify-content-between">
							<button type="button" class="btn btnThemeOutine btnThemeOutineNotWhite text-uppercase" data-hover="Filter">
								<span class="d-block btnText">Filter</span>
							</button>
							<p id="amount" class="font-weight-light"></p>
						</div>
					</div>
					<!-- rpListWidget -->
					<div class="widget rpListWidget">
						<h3 class="text-capitalize">Relatest Product</h3>
						<ul class="list-unstyled pl-0 mb-0">
							<li class="hasOver">
								<!-- imgWrap -->
								<div class="alignleft imgWrap text-center">
									<a href="javascript:void(0);">
										<img src="images/img70.png" alt="image description">
									</a>
								</div>
								<div class="descrWrap">
									<h4><a href="javascript:void(0);">Afteroom Loun Chaira</a></h4>
									<h5 class="font-weight-normal fontBase">$22.09</h5>
								</div>
							</li>
							<li class="hasOver">
								<!-- imgWrap -->
								<div class="alignleft imgWrap text-center">
									<a href="#">
										<img src="images/img71.png" alt="image description">
									</a>
								</div>
								<div class="descrWrap">
									<h4><a href="javascript:void(0);">Table Afteroom Upholstered</a></h4>
									<h5 class="font-weight-normal fontBase">$27.03</h5>
								</div>
							</li>
							<li class="hasOver">
								<!-- imgWrap -->
								<div class="alignleft imgWrap text-center">
									<a href="javascript:void(0);">
										<img src="images/img72.png" alt="image description">
									</a>
								</div>
								<div class="descrWrap">
									<h4><a href="javascript:void(0);">Standing Bowl Two Small</a></h4>
									<h5 class="font-weight-normal fontBase">$29.99</h5>
								</div>
							</li>
							<li class="hasOver">
								<!-- imgWrap -->
								<div class="alignleft imgWrap text-center">
									<a href="javascript:void(0);">
										<img src="images/img73.png" alt="image description">
									</a>
								</div>
								<div class="descrWrap">
									<h4><a href="javascript:void(0);">Yucca Wood Stand Round</a></h4>
									<h5 class="font-weight-normal fontBase">$18.99</h5>
								</div>
							</li>
						</ul>
					</div>
					...
					<div id="tag_cloud-2" class="widget widget_tag_cloud">
						...
						<div class="tagcloud d-flex flex-wrap text-capitalize">
							<!-- tagcloudItem -->
							<a href="javascript:void(0);" class="d-inline-block tagcloudItem rounded">Chairs</a>
							<!-- tagcloudItem -->
							<a href="javascript:void(0);" class="d-inline-block tagcloudItem rounded">Table</a>
							<!-- tagcloudItem -->
							<a href="javascript:void(0);" class="d-inline-block tagcloudItem rounded">Red</a>
							<!-- tagcloudItem -->
							<a href="javascript:void(0);" class="d-inline-block tagcloudItem rounded">Classic</a>
							<!-- tagcloudItem -->
							<a href="javascript:void(0);" class="d-inline-block tagcloudItem rounded">Luxurious</a>
						</div>
					</div>
					<!-- helpVisualWidget -->
					<div class="widget helpVisualWidget text-center bgCover position-relative rounded hasShadow text-white" style="background-image: url(images/img01.jpg);">
						<div class="align position-relative">
							<h3 class="text-capitalize fontBase">
								<span class="d-block">Call Us Need Help ?</span>
								<span class="d-block">01-2222-456</span>
							</h3>
							<a href="tel:&#048;&#049;&#050;&#050;&#050;&#050;&#052;&#053;&#054;" class="btn btnTheme font-weight-normal text-uppercase" data-hover="Call Us">
