        <!-- pageFooterAreaWrap -->
        <div class="pageFooterAreaWrap position-relative text-center text-sm-left" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>assets/images/img01.jpg">
            ...
            <div class="container position-relative pageFooterWrapHolder">
                ...
                <footer id="pageFooter" class="position-relative">
                    <div class="row">
                        <div class="col col-12 col-md-3 col-lg-3 order-lg-3">
                            <!-- ftLinksNav -->
                        ...
                        <div class="col col-12 col-lg-4 order-lg-1 text-center text-lg-left position-static">
                            ...
                            <div class="logo">
                                <a href="home.html">
                                    <img src="<?php echo base_url(); ?>assets/images/logoWhite.png" alt="gallery dekoruma">
                                </a>
                            </div>
                            <!-- ftAddress -->
