				...
				<div class="container">
					<div class="row align-items-md-center">
						...
						<div class="col-12 col-md-5 d-none d-md-flex align-items-md-center justify-content-md-end">
							<!-- title -->
							<strong class="title d-block text-right fontRoboto fwMedium text-capitalize text-dark">Shop details</strong>
						</div>
					</div>
				</div>
			</nav>
			<!-- cartAreaBlock -->
			<section class="contentBlock cartAreaBlock">
				<div class="container">
					<!-- cartTableWrap -->
					<div class="cartTableWrap table-responsive">
						<!-- cartTable -->
						<table class="table cartTable text-center mb-0">
							<!-- thead -->
							<thead>
								<tr>
									<!-- col01 -->
									<th class="col01 fontRoboto">&nbsp;</th>
									<!-- col02 -->
									<th class="col02 fontRoboto">Product</th>
									<!-- col03 -->
									<th class="col03 fontRoboto">Price</th>
									<!-- col04 -->
									<th class="col04 fontRoboto">Quality</th>
									<!-- col05 -->
									<th class="col05 fontRoboto">Total</th>
								</tr>
							</thead>
							<!-- tbody -->
							<tbody>
								<tr>
									...
									<td class="col03">
										<!-- tdWrap -->
										<div class="tdWrap">
											<h4 class="font-weight-normal price">$ 60.00</h4>
										</div>
									</td>
									<!-- col04 -->
									<td class="col04">
										...
										<div class="tdWrap">
											<!-- quantity -->
											<div class="quantity quantityLight position-relative clearfix d-inline-block align-top">
												<input type="number" min="1" max="9" step="1" value="2">
											</div>
										</div>
									</td>
									<!-- col05 -->
									<td class="col05">
										<!-- tdWrap -->
										<div class="tdWrap">
											<h4 class="font-weight-normal price">$ 120.00</h4>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="col03">
										<!-- tdWrap -->
										<div class="tdWrap">
											<h4 class="font-weight-normal price">$ 80.00</h4>
										</div>
									</td>
									<!-- col04 -->
									<td class="col04">
									...
									<td class="col05">
										<!-- tdWrap -->
										<div class="tdWrap">
											<h4 class="font-weight-normal price">$ 400.00</h4>
										</div>
									</td>
								</tr>
							</tbody>
							...
							<tfoot>
								<tr>
									<td colspan="5">
										...
										<div class="tdWrap">
											<!-- coupenEnterWrap -->
											<div class="coupenEnterWrap d-flex">
												<div class="wrap1 d-flex align-items-center">
													<!-- coupenFormControl -->
													<input type="text" class="form-control coupenFormControl text-center" placeholder="Your Coupon">
													<button class="btn btnTheme" type="submit" data-hover="Apply coupon">
														<span class="d-block btnText">Apply coupon</span>
													</button>
												</div>
												<button class="btn btnDefaultOutline text-capitalize float-right" type="submit" data-hover="Update Cart">
					...
					<div class="row">
						<div class="col-12 offset-md-4 col-md-8 offset-lg-6 col-lg-6">
							<!-- cartTotal -->
							<table class="table cartTotal text-dark">
								<thead>
									<tr>
										<th colspan="2" class="fontRoboto">Cart Totals</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td class="col02">
											<!-- tdWrap -->
											<div class="tdWrap">
												<strong class="font-weight-normal price d-block text-right">$ 520.00</strong>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td class="col01">
											<!-- tdWrap -->
											<div class="tdWrap">
												<strong class="fwMedium d-block textLarge">Total</strong>
											</div>
										</td>
										<!-- col02 -->
										<td class="col02">
											<!-- tdWrap -->
											<div class="tdWrap">
												<strong class="fwMedium price d-block text-right textLarge">$ 520.00</strong>
											</div>
										</td>
									</tr>
								</tbody>
								<tfoot>
									<tr>
										<td colspan="2">
											...
											<div class="tdWrap">
												<!-- button -->
												<button class="btn btnTheme w-100 d-block text-uppercase" type="submit" data-hover="PROCEED TO CHECKOUT">
