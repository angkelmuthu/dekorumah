						...
						<div class="row align-items-md-center">
							<div class="col-12 col-md-6 colImage">
								...
								<div class="prjctColumnImageWrap alignleft rounded">
									<img class="d-block w-100 rounded" src="http://placehold.it/670x450" alt="image description">
								</div>
							</div>
							<div class="col-12 col-md-6 colDescr">
								...
								<div class="bg-white hasShadow rounded prjctTextHolder position-relative">
									<!-- postTitleTextTag -->
									<strong class="d-block postTitleTextTag font-weight-normal text-capitalize">Vintage / Morden</strong>
									<h3 class="text-capitalize">Name Project: <a href="project-details.html">Black And White Kitchens</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									<a href="project-details.html" class="btnMore d-inline-block">Details <i class="icn ei_arrow_right"><span class="sr-only">icon</span></i></a>
								</div>
							</div>
						</div>
					</article>
					...
					<article class="prjctDescrColumn hasMbBottom prjctDescrColumnOrderInverse text-md-right hasOver">
						<div class="row align-items-md-center">
							...
							<div class="col-12 col-md-6 order-md-1 colDescr">
								...
								<div class="bg-white hasShadow rounded prjctTextHolder position-relative">
									<!-- postTitleTextTag -->
									<strong class="d-block postTitleTextTag font-weight-normal text-capitalize">Minimal / Luxury</strong>
									<h3 class="text-capitalize">Name Project: <a href="project-details.html">Kitchen Furniture</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									<a href="project-details.html" class="btnMore d-inline-block">Details <i class="icn ei_arrow_right"><span class="sr-only">icon</span></i></a>
								</div>
							</div>
					...
					<article class="prjctDescrColumn hasMbBottom hasOver">
						<div class="row align-items-md-center">
							...
							<div class="col-12 col-md-6 colDescr">
								...
								<div class="bg-white hasShadow rounded prjctTextHolder position-relative">
									<!-- postTitleTextTag -->
									<strong class="d-block postTitleTextTag font-weight-normal text-capitalize">Coastal</strong>
									<h3 class="text-capitalize">Name Project: <a href="project-details.html">Kitchens At The Home Depot</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									<a href="project-details.html" class="btnMore d-inline-block">Details <i class="icn ei_arrow_right"><span class="sr-only">icon</span></i></a>
								</div>
							</div>
					...
					<article class="prjctDescrColumn hasMbBottom prjctDescrColumnOrderInverse text-md-right hasOver">
						<div class="row align-items-md-center">
							...
							<div class="col-12 col-md-6 order-md-1 colDescr">
								...
								<div class="bg-white hasShadow rounded prjctTextHolder position-relative">
									<!-- postTitleTextTag -->
									<strong class="d-block postTitleTextTag font-weight-normal text-capitalize">Royal / Luxury</strong>
									<h3 class="text-capitalize">Name Project: <a href="project-details.html">Royal Kitchen &amp; Bath</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									<a href="project-details.html" class="btnMore d-inline-block">Details <i class="icn ei_arrow_right"><span class="sr-only">icon</span></i></a>
								</div>
							</div>
