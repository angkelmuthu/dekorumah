				...
				<div class="container">
					<div class="row mb-5 align-items-center">
						<div class="col-12 col-md-5">
							...
							<p><span class="fontRoboto">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</span></p>
							<!-- ctAddress -->
							<address class="ctAddress text-dark">
								<ul class="list-unstyled">
									<li class="d-flex align-items-center">
										...
										<strong class="text font-weight-normal">40 Baria Sreet 133/2 NewYork, US</strong>
									</li>
									<li class="d-flex align-items-center">
									...
									<li class="d-flex align-items-center">
										...
										<strong class="text font-weight-normal"><a href="tel:+&#049;&#050;&#051;&#052;&#053;&#054;&#055;&#056;&#057;&#049;&#049;&#050;&#048;">(+123) 456-789-1120</a></strong>
									</li>
								</ul>
							</address>
						</div>
					...
					<div class="ctMapHolder position-relative ">
						<!-- map -->
						<span class="bgCover map d-block" style="background-image: url(images/mapPlaceholder01.jpg);"><span class="sr-only">map placeholder</span></span>
					</div>
				</div>
			</section>
		</main>
