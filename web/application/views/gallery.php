				...
				<div class="container">
					<div class="row align-items-md-center">
						...
						<div class="col-12 col-md-5 d-none d-md-flex align-items-md-center justify-content-md-end">
							<!-- title -->
							<strong class="title d-block text-right fontRoboto fwMedium text-capitalize text-dark">gallery</strong>
						</div>
					</div>
				</div>
			</nav>
			<section class="galleryAreaBlock contentBlock position-relative">
				<div id="customScrollHorizontal" class="cshHolderWrap">
					<div class="extraWrap">
						<div class="cshColumn cshColumnFull">
							<!-- prPostColumn -->
							<article class="prPostColumn prPostColumnInGallery position-relative mb-0">
								<a class="d-block" data-fancybox="gallery" href="images/img99.jpg" data-caption="Kitchen furniture for you with elegant style and elegance">
									<!-- prColumnBgCover -->
									<span class="bgCover prColumnBgCover d-block" style="background-image: url(http://placehold.it/1170x700);">
										<img class="sr-only" src="http://placehold.it/1170x700" alt="image description">
									</span>
									<!-- prPostCaption -->
									<div class="prPostCaption bg-white rounded">
										<h3>
											<!-- hTitle -->
											<strong class="font-weight-normal hTitle d-block fontBase">Building</strong>
											<span class="d-block">Kitchen furniture for you with elegant style and elegance</span>
										</h3>
									</div>
								</a>
							</article>
						...
						<div class="cshColumn cshColumnFull">
							<!-- prPostColumn -->
							<article class="prPostColumn prPostColumnInGallery position-relative mb-0">
								<a class="d-block" data-fancybox="gallery" href="images/img97.jpg" data-caption="Kitchen furniture for you with elegant style and elegance">
									<!-- prColumnBgCover -->
									<span class="bgCover prColumnBgCover d-block" style="background-image: url(http://placehold.it/1170x700);">
										<img class="sr-only" src="http://placehold.it/1170x700" alt="image description">
									</span>
						...
						<div class="cshColumn cshColumnFull">
							<!-- prPostColumn -->
							<article class="prPostColumn prPostColumnInGallery position-relative mb-0">
								<a class="d-block" data-fancybox="gallery" href="images/img98.jpg" data-caption="Kitchen furniture for you with elegant style and elegance">
									<!-- prColumnBgCover -->
									<span class="bgCover prColumnBgCover d-block" style="background-image: url(http://placehold.it/1170x700);">
										<img class="sr-only" src="http://placehold.it/1170x700" alt="image description">
									</span>
