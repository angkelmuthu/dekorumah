					...
					<div class="row">
						<div class="col-12 col-md-8 col-lg-9">
							...
							<article id="content" class="mb-5">
								...
								<header class="ctSorterWrapHeader">
									<div class="row align-items-md-center">
										<div class="col-9 col-md-5">
											<p><strong class="font-weight-normal">Showing 10–18 of 55 results</strong></p>
										</div>
										<div class="col-3 col-md-7 d-md-flex justify-content-md-end">
											...
											<ul class="list-unstyled viewSorterList d-flex justify-content-end align-items-center mb-0">
												<li class="active"><a href="#"><i class="fas fa-bars"><span class="sr-only">icon</span></i></a></li>
												<li><a href="javascript:void(0);"><i class="fas fa-th-large"><span class="sr-only">icon</span></i></a></li>
											</ul>
										</div>
									</div>
								</header>
								...
								<nav aria-label="Page navigation">
									<!-- pagination -->
									<ul class="pagination pagePagination justify-content-center text-center mb-0 pt-lg-4">
						...
						<div class="col-12 col-md-4 col-lg-3">
							...
							<aside id="sidebar">
								...
								<div class="widget rpListWidget">
									...
									<ul class="list-unstyled pl-0 mb-0">
										...
										<li class="hasOver">
											...
											<div class="descrWrap">
												<h4><a href="shop-details.html">Yucca Wood Stand Round</a></h4>
								...
								<!-- helpVisualWidget -->
								<div class="widget helpVisualWidget text-center bgCover position-relative rounded hasShadow text-white" style="background-image: url(http://placehold.it/230x150);">
