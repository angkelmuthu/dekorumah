				...
				<div class="container">
					...
					<article id="content" class="mb-5">
							...
							<div class="row align-items-md-center">
								...
								<div class="col-3 col-md-7 d-md-flex justify-content-md-end">
									...
									<ul class="list-unstyled viewSorterList d-flex justify-content-end align-items-center mb-0">
										<li><a href="javascript:void(0);"><i class="fas fa-bars"><span class="sr-only">icon</span></i></a></li>
										<li class="active"><a href="javascript:void(0);"><i class="fas fa-th-large"><span class="sr-only">icon</span></i></a></li>
									</ul>
								</div>
							</div>
						</header>
						<!-- popItemColumn__listView -->
						<article class="popItemColumn__listView hasOver d-sm-flex align-items-lg-center">
							<!-- imgHolder -->
							<div class="imgHolder text-center flex-shrink-0">
								<img src="http://placehold.it/240x165" alt="image description">
							</div>
							<!-- descriptionWrap -->
							<div class="descriptionWrap">
								<h2 class="text-capitalize"><a href="shop-details.html">Afteroom Lounge Chair</a></h2>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant doloremque laudantium eaque ipsa quae.</p>
								<h3 class="fontBase font-weight-normal">$22.99</h3>
								<a href="javascript:void(0);" class="btn btnThemeOutine btnThemeOutineNotWhite text-uppercase" data-hover="Buy Now">
									<span class="d-block btnText">Buy Now</span>
								</a>
							</div>
						</article>
						<!-- popItemColumn__listView -->
						<article class="popItemColumn__listView hasOver d-sm-flex align-items-lg-center">
							...
							<!-- descriptionWrap -->
							<div class="descriptionWrap">
								<h2 class="text-capitalize"><a href="shop-details.html">Afteroom Upholstered</a></h2>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant doloremque laudantium eaque ipsa quae.</p>
								<h3 class="fontBase font-weight-normal">$22.99</h3>
								<a href="javascript:void(0);" class="btn btnThemeOutine btnThemeOutineNotWhite text-uppercase" data-hover="Buy Now">
									<span class="d-block btnText">Buy Now</span>
						...
						<article class="popItemColumn__listView hasOver d-sm-flex align-items-lg-center">
							...
							<!-- descriptionWrap -->
							<div class="descriptionWrap">
								<h2 class="text-capitalize"><a href="shop-details.html">Standing Bowl - Small</a></h2>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant doloremque laudantium eaque ipsa quae.</p>
								<h3 class="fontBase font-weight-normal">$22.99</h3>
								<a href="javascript:void(0);" class="btn btnThemeOutine btnThemeOutineNotWhite text-uppercase" data-hover="Buy Now">
									<span class="d-block btnText">Buy Now</span>
						...
						<article class="popItemColumn__listView hasOver d-sm-flex align-items-lg-center">
							...
							<!-- descriptionWrap -->
							<div class="descriptionWrap">
								<h2 class="text-capitalize"><a href="shop-details.html">Cabinet Kitchen Wood</a></h2>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant doloremque laudantium eaque ipsa quae.</p>
								<h3 class="fontBase font-weight-normal">$22.99</h3>
								<a href="javascript:void(0);" class="btn btnThemeOutine btnThemeOutineNotWhite text-uppercase" data-hover="Buy Now">
									<span class="d-block btnText">Buy Now</span>
					...
					<div class="widget rpListWidget">
						...
						<ul class="list-unstyled pl-0 mb-0">
							<li class="hasOver">
								...
								<div class="descrWrap">
									<h4><a href="shop-details.html">Afteroom Loun Chaira</a></h4>
							...
							<li class="hasOver">
								...
								<div class="descrWrap">
									<h4><a href="shop-details.html">Table Afteroom Upholstered</a></h4>
							...
							<li class="hasOver">
								...
								<div class="descrWrap">
									<h4><a href="shop-details.html">Standing Bowl Two Small</a></h4>
