...
<body class="cominSoon">
	<!-- pageWrapper -->
	<div id="pageWrapper">
		<!-- pageHeader -->
		<header id="pageHeader" class="pageHeader04 position-absolute">
			<!-- pageHeaderTopBar -->
			<div class="pageHeaderTopBar pageHeaderTopBar04 text-white">
				<div class="container clearfix position-relative">
					<div class="row">
						<div class="col-3 col-lg-7">
							<!-- topBarContactList -->
							<ul class="list-unstyled topBarContactList barTransparent align-items-center mb-0 d-none d-md-flex">
								<li>
						...
						<div class="col-9 col-lg-5 d-flex justify-content-end">
							...
							<div class="shareWTitleWrap d-flex align-items-center">
								...
								<!-- socialLinksSimple -->
								<ul class="list-unstyled socialNetworks socialLinksSimple socialLinksSimpleWhite d-flex align-items-center justify-content-end mb-0">
									<li>
		...
		<main>
			<!-- pageFullBlock -->
			<section class="pageFullBlock bgCover text-white text-center position-relative" style="background-image: url(http://placehold.it/1920x1080);">
				<div class="container holder position-relative">
					<div class="align">
						<!-- signWarn -->
						<i class="ei_icon_info d-block signWarn"></i>
						<h2 class="text-uppercase font-weight-bold fontBase">Opps! This page Could Not Be Found!</h2>
						<p>Sorry bit the page you are looking for does not exist, have been removed or name changed</p>
						<!-- btnsWrap -->
						<footer class="btnsWrap d-flex flex-wrap justify-content-center">
							<a href="home.html" class="btn btnThemeOutine text-uppercase btnRoudedLarge" data-hover="Go Back">
								<span class="d-block btnText">Go Back</span>
							</a>
							<a href="home.html" class="btn btnTheme text-uppercase btnRoudedLarge" data-hover="Home Page">
								<span class="d-block btnText">Home Page</span>
							</a>
						</footer>
					</div>
				</div>
