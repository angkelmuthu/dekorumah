				...
				<div class="container">
					<div class="row align-items-md-center">
						...
						<div class="col-12 col-md-5 d-none d-md-flex align-items-md-center justify-content-md-end">
							<!-- title -->
							<strong class="title d-block text-right fontRoboto fwMedium text-capitalize text-dark">Check Out</strong>
						</div>
					</div>
				</div>
			</nav>
			<!-- checkoutAreaBlock -->
			<section class="contentBlock checkoutAreaBlock">
				<div class="container">
					<form action="#">
						<!-- checkoutAlert -->
						<aside class="alert alert-light checkoutAlert">Have a coupon? Click <a href="#">here</a> to enter your code</aside>
						<!-- checkoutAlert -->
						<aside class="alert alert-light checkoutAlert">Returning customer? Click <a href="#">here</a> to Login or create an account</aside>
						<!-- bilingDetailsWrap -->
						<div class="bilingDetailsWrap">
							<h3 class="text-capitalize">Billing Details</h3>
							<div class="row">
									...
									<div class="form-row">
										...
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">First Name</span>
										...
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">Last Name</span>
												<input type="text" class="form-control d-block w-100">
											</label>
										</div>
										<!-- formCol -->
										...
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												...
												<input type="email" class="form-control d-block w-100" placeholder="info@hotmail.com">
											</label>
										</div>
										<!-- formCol -->
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												...
												<input type="tel" class="form-control d-block w-100" placeholder="(+12) 345 678 90">
											</label>
										</div>
										<!-- formCol -->
										<div class="formCol">
										...
										<div class="formCol">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">Address</span>
										...
										<div class="formCol">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">Town / City </span>
												<input type="text" class="form-control d-block w-100" placeholder="Town / City">
											</label>
										</div>
										<!-- formCol -->
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">State/ Country</span>
												<input type="email" class="form-control d-block w-100" placeholder="Make a selection">
											</label>
										</div>
										<!-- formCol -->
										<div class="formCol formCol50">
											...
											<label class="form-group d-block">
												<!-- fLabel -->
												<span class="fLabel text-capitalize d-block">Postcode / ZIP</span>
												<input type="tel" class="form-control d-block w-100" placeholder="Postcode / ZIP">
											</label>
										</div>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<!-- confirmationBoxWrap -->
									<div class="confirmationBoxWrap rounded position-relative">
										<h3 class="text-capitalize">Your Order</h3>
										<!-- checkoutCountTable -->
										<table class="table checkoutCountTable">
											<!-- thead -->
											<thead>
												<tr>
											...
											<tbody>
												<tr>
													...
													<td class="col02">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="font-weight-normal price d-block">$ 80.00</strong>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td class="col02">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="font-weight-normal price d-block">$ 20.00</strong>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td class="col02">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="font-weight-normal price d-block">$ 70.00</strong>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td class="col02">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="font-weight-normal price d-block">$ 170.00</strong>
														</div>
													</td>
												</tr>
											</tbody>
											...
											<tfoot>
												<tr>
													...
													<td class="col01">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="fwMedium textLarge text-dark">Total</strong>
														</div>
													</td>
													<!-- col02 -->
													<td class="col02">
														<!-- tdWrap -->
														<div class="tdWrap">
															<strong class="font-weight-normal textLarge price">$ 170.00</strong>
														</div>
													</td>
												</tr>
											</tfoot>
										...
										<ul class="list-unstyled pmSlctList mb-0">
											<li>
												<div class="custom-control custom-radio">
													<input type="radio" id="01" name="pmMethod" class="custom-control-input">
													<label class="custom-control-label" for="01">Direct Bank Transfer</label>
												</div>
											</li>
											<li>
												<div class="custom-control custom-radio">
													<input type="radio" id="02" name="pmMethod" class="custom-control-input" checked>
													<label class="custom-control-label" for="02">Paypal 
														<img class="pmPlaceholderImage d-none d-lg-inline" src="images/paymentMethodPlaceholder01.jpg" width="200" height="52" alt="image description">
														<!-- pmNotePop -->
														<strong class="pmNotePop font-weight-normal text-dark bg-light position-relative d-block w-100">You can pay with your credit card if you don’t have a PayPal account.</strong>
													</label>
												</div>
											</li>
										</ul>
										<div class="btnWrap text-center text-md-left">
											<!-- button -->
											<button class="btn btnTheme text-uppercase" type="submit" data-hover="Process Order">
												<span class="d-block btnText">Process Order</span>
											</button>
										</div>
									</div>
								</div>
