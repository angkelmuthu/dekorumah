...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Id Group Sub</td><td><?php echo $id_group_sub; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_pembukuan') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
