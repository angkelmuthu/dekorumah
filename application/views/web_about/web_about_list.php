                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <!-- <div class="text-center">
                            <?php echo anchor(site_url('web_about/create'), '<i class="fal fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-primary btn-sm waves-effect waves-themed"'); ?></div> -->
