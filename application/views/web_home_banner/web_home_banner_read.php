                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td></td>
                                <td><a href="<?php echo site_url('web_home_banner') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
