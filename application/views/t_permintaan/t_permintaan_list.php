        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#dt-basic-example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "t_permintaan/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_permintaan",
                            "orderable": false
                        },{"data": "jenis_permintaan"},{"data": "id_pelanggan"},{"data": "id_barang"},{"data": "qty"},{"data": "deskripsi"},{"data": "id_users"},{"data": "create_by"},{"data": "create_date"},
                        {
                            "data" : "action",
                            "orderable": false,
