    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>KELOLA DATA LAPORAN AKUNTANSI</h2>
                    ...
                    <div class="panel-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php echo anchor(site_url('t_keuangan/excel'), '<i class="fal fa-file-excel" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-outline-success btn-sm waves-effect waves-themed"'); ?></div>
                            <div class="col-md-6">
                                <form action="<?php echo site_url('t_keuangan/index'); ?>" method="get">
                                        ...
                                        <div class="input-group">
                                            ...
                                            ?>
                                                <div class="input-group-prepend">
                                                    <a href="<?php echo site_url('t_keuangan'); ?>" class="btn btn-danger waves-effect waves-themed">Reset</a>
                                                </div>
                                            <?php
                                            }
                                            ?>
                    ...
                    <div class="panel-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody><?php
                                        foreach ($t_keuangan_data as $t_keuangan) {
                                        ?>
                                        <tr>
