                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="<?php echo site_url('m_survei/pesanan/index'); ?>" method="get">
                                        ...
                                        <div class="input-group">
                                            ...
                                            ?>
                                                <div class="input-group-prepend">
                                                    <a href="<?php echo site_url('m_survei/pesanan/'); ?>" class="btn btn-danger waves-effect waves-themed">Reset</a>
                                                </div>
                                            <?php
                                            }
                                            ?>
